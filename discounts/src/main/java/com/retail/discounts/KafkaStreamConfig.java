...
public class KafkaStreamConfig {
  ...
  public org.springframework.kafka.config.StreamsBuilderFactoryBean app1StreamBuilderFactoryBean() {
    Map<String, Object> config = new HashMap<>();
    setDefaults(config);
    ...
    return new org.springframework.kafka.config.StreamsBuilderFactoryBean(config);

  }

  //
  @Bean("app2StreamBuilder")
  public org.springframework.kafka.config.StreamsBuilderFactoryBean app2StreamBuilderFactoryBean() {
    Map<String, Object> config = new HashMap<>();
    setDefaults(config);
    config.put(StreamsConfig.PROCESSING_GUARANTEE_CONFIG, StreamsConfig.EXACTLY_ONCE);
